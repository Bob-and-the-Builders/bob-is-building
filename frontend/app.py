...
video_analytics_page = st.Page("pages/video_analytics.py", title="Video Analytics", icon="📊")
    ...
    pg = st.navigation(
        {
            ...
            "Content Creator Portal": [dashboard, upload_video, video_analytics_page, payout, kyc_page],
        }
    )
else:
